...
1. The explicit implementation prompt attached on 2026-08-03.
2. Approved documents in `Doc/`.
3. Repository guidance and documentation.
4. Source code.
5. Recorded engineering assumptions.

Approved baseline documents read in full:
